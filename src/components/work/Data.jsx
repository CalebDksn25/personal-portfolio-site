...
import orderlySheet from "../../assets/orderlySheet.png";
...
export const projectsData = [
  {
    id: 1,
    images: [orderlyIMG, orderlySheet], // Ensure images is an array
    title: "Orderly Site",
    category: "Web Development",
    description:
      "The Orderly website was made to showcase the Orderly Software, whilst still ensuring a clean and professional look for the users. The website was made using HTML, React.JS, CSS, and JavaScript.",
  },
  {
    id: 2,
    images: [
    ...
    description:
      "Greek Gate is a mobile application designed to streamline the proccess of managing fraternity and sorority recruitment events. The app was made using SwiftUI and XCode, ensuring user privacy, as well as a clean and professional look, in order to keep users coming back.",
  },
  {
    id: 3,
  ...
  {
    id: 5,
    images: [orderlySheet, orderlyIMG], // Ensure images is an array
